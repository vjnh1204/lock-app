...
class FirstActivity : AppCompatActivity() {
    ...
    private var patternLockActivityLauncher : ActivityResultLauncher<Intent> = registerForActivityResult(
        ...
        if(result.resultCode == Activity.RESULT_OK){
            ...
            if(data != null){
                ...
                btnCreatePass?.background?.setTintList(ContextCompat.getColorStateList(this, R.color.colorGray))
    ...
    private fun showBtnStart(){
        ...
        if (checkButtonCreateClick && checkButtonPermissionClick){
    ...
    override fun onResume() {
        if(Utils.permissionCheck(this)){
            ...
            btnSettingPermission?.background?.setTintList(ContextCompat.getColorStateList(this,R.color.colorGray))
            ...
            btnSettingPermission?.background?.setTintList(ContextCompat.getColorStateList(this,R.color.colorButton))
        }
        showBtnStart()
        super.onResume()
    }
